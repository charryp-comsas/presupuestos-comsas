...
def leer_gastos_pendientes(supabase_url: str, service_key: str) -> list:
    ...
    OJO 2: con las claves nuevas de Supabase (sb_secret_...) solo se
    debe enviar el header "apikey" -- NO "Authorization: Bearer",
    porque ese header espera un JWT y la clave secreta nueva no lo es
    (ver docs de Supabase "API Keys")."""
